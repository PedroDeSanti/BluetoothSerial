...
//// HAL_UART_Transmit_DMA(uart_handle, this->tx_data, PACKET_SIZE);

// HAL_UART_Transmit(uart_handle, this->tx_data, PACKET_SIZE, 1000);
// HAL_UART_Receive(uart_handle, this->rx_data, PACKET_SIZE, 1000);
